...
export class LineChartViewportChange {
  ...
  render() {
    return (
      <div>
        <button id="toggle-view-port" onClick={() => this.setViewPort(NARROW_VIEWPORT)}>
          use narrow viewport
        </button>
        <button id="toggle-view-port" onClick={() => this.setViewPort(WIDE_VIEWPORT)}>
          use wide viewport
        </button>
        <button id="toggle-view-port" onClick={() => this.setViewPort(FIVE_MINUTE_VIEWPORT)}>
          use 5 minute viewport
        </button>
        <button id="toggle-view-port" onClick={() => this.setViewPort(THIRTY_MINUTE_VIEWPORT)}>
